  ...
  <div class="container-fluid">
    <div class="card m-3 text-center shadow">
      ...
      <div class="text-center">
        ...
        Dengan nama asli saya <b>Fahad Vidjar Apriza</b><br/>Bahasa pemrograman yang saya ketahui hanya sedikit, yaitu (HTML/JavaScript), Python, C++<b/><br/>Saya juga mempunyai projects bot whatsapp yang sekarang masih dalam pengembangan, mohon dukungan dan doa nya agar bot whatsapp saya bermanfaat bagi semuanya<br/>Terimakasih Telah Berkunjung.</p>
      </div>
    </div>
  </div>
